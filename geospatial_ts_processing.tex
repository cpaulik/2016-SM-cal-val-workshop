...
\begin{columns}
  ...
  \block{}{ 
    ...
    \block{4. Processing SMAP data with \code{poets\degree}}{
      ...
      the NASA servers and also supports authentification.

     \begin{tcolorbox}
     \label{lst:read_smap}
     \inputminted[bgcolor=light-gray]{bash}{download_smap.sh}
     \end{tcolorbox}
     \captionof{listing}{Downloading SMAP SPL3SMP image data using the \code{smap\_io} package.}
    ...
    \block{5. Extending \code{poets\degree}}{
      \begin{multicols}{2}
