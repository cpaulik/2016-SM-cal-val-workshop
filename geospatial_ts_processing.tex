...
\begin{columns}
  ...
  \block{1. Introduction}{
    \begin{multicols}{2}
      ...
      open source Python packages for processing geospatial time series data.
      These packages are well suited for the validation of soil moisture
      datasets but can be used for any type of geospatial time series analyses.

    \end{multicols}
  }


  \block{3. Features and Supported Datasets}{
    \begin{multicols}{2}

      this purpose which covers data downloading, conversion, reading,
      temporal matching, scaling, metric calculation and storage of results. It
      supports common in-situ (ISMN), remotely sensed (ASCAT, CCI, SMOS, SMAP)
      as well as often used model data (GLDAS, ERA Interim/Land).
  ...
  \begin{subcolumns}
    ...
    \figureblock{}{
      \begin{tikzfigure}[A common workflow showing the preprocessing steps
        necessary during data preparation.\label{fig:hw}]
    ...
    \block{2. Geospatial time series processing}{
      ...
      Geospatial time series generally involves 
